...
The player starts as an ambitious job applicant entering a high-stakes, fast-paced hotel environment in Greece. They select one of three foundational entry-level roles: Commis Chef (Γ Μάγειρας), Commis Waiter (Βοηθός Σερβιτόρου), or Receptionist (F.O AGENT). The tone is highly realistic, intense, and corporate, demanding professional reflexes, crisis management, and diplomatic tact under manipulative or high-pressure supervision.

## 2. PLAYER ROLES & DETAILED CAREER LADDERS
- F.O AGENT (The Front Line): F.O AGENT -> Assistant Fom -> Front Office Manager -> Operations Manager -> General Manager.
