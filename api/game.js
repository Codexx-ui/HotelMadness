...
- Other Staff/Guests: Do NOT make every scene about guest problems. At least 40% of scenes must be simple interpersonal issues with colleagues (gossip, favors, breaks, arguments) without guest or GM involvement. **Crucial:** Adapt these colleague interactions strictly to the player's specific Role environment (e.g., gossip at the front desk for Receptionists, in the kitchen for Chefs, in the maintenance room for Handyman, or in the hallways for Housekeeping).
